...
window.Modernizr = function (a, b, c) {
    ...
    function K() {
        ...
        e.inputtypes = function (a) {
            for (var d = 0, e, f, h, i = a.length; d < i; d++) 
                ...
                e = k.type !== "text",
                e && (k.value = l, k.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(f) && k.style.WebkitAppearance !== c
                    ...
                    : /^(search|tel)$/.test(f) || (/^(url|email)$/.test(f)
    ...
    s.csstransforms3d = function () {
        var a = !!J("perspective");
        return a && "webkitPerspective" in g.style && y("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolu" +
                "te;height:3px;}}",
        function (b, c) {
    ...
    for (var L in s) 
        C(s, L) && (x = L.toLowerCase(), e[x] = s[L](), v.push((e[x]
            ? ""
            : "no-") + x));
    return e.input || K(),
    e.addTest = function (a, b) {
        if (typeof a == "object") 
            ...
            b = typeof b == "function"
                ? b()
                : b,
            typeof f != "undefined" && f && (g.className += " " + (b
                ? ""
                : "no-") + a),
            e[a] = b
        }
    ...
    function (a, b) {
        ...
        function q(a) {
            a || (a = b);
            var c = m(a);
            return r.shivCSS && !f && !c.hasCSS && (c.hasCSS = !!k(a, "article,aside,figcaption,figure,footer,header,hgroup,nav,section{display:block}m" +
                    "ark{background:#FF0;color:#000}")),
            j || p(a, c),
            a
        }
        var c = a.html5 || {},
        ...
        var r = {
            elements: c.elements || "abbr article aside audio bdi canvas data datalist details figcaption figure foot" +
    ...
    B = function (a) {
        ...
        function g(a, e, f, g, h) {
            ...
            i.bypass || (e && (e = d(e)
                ...
                : (y[i.url]
                    ? i.noexec = !0
                    : y[i.url] = 1, f.load(i.url, i.forceCSS || !i.forceJS && "css" == i.url.split(".").pop().split("?").shift()
                    ? "c"
                    : c, i.noexec, i.attrs, i.timeout), (d(e) || d(j)) && f.load(function () {
                    k(),
                    e && e(i.origUrl, h, g),
                    j && j(i.origUrl, h, g),
                    y[i.url] = 2
